...
theme.Slideshow = (function() {
  ...
  function slideshow(el, sectionId) {
    ...
    this.$arrows.find('.slideshow__arrow-left').on('click', function() {
      $slideshow.slick('slickPrev');
    });
    this.$arrows.find('.slideshow__arrow-right').on('click', function() {
...
theme.ProductRecommendations = (function() {
  function ProductRecommendations(container) {
    ...
    var recommendationsSectionUrl =
      ...
      productId +
      '&limit=12';
      var ProductRecommendations = '.recommendations-products-wrap';
  ...
  function productRecommendations(x) {
    $(x).addClass('owl-carousel');
    $(x).owlCarousel({
      nav: true,
      dots: true,
      loop: true,
